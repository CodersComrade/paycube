        ...
        <>
            <div className="container-fluid features-section py-5">
                ...
                <div className="container-fluid feature-bg my-5">
                    <div className="card mb-3 feature-box container py-5">
                        <div className="row g-5">
                            ...
                            <div className="col-md-5">
                                <div className="card-body">
                                    <h3 className="card-title text-white feature-title mb-5">Manage Your <span className="feature-title-color">Personal Finance</span></h3>
                ...
                <div className="container-fluid feature-bg2">
                    <div className="card mb-3 feature-box container my-5">
                        <div className="row g-5">
                            <div className="col-md-5">
                                <div className="card-body">
                                    <h3 className="card-title text-white feature-title mb-5">Set Your <span className="feature-title-color">Budget Plans</span></h3>
                ...
                <div className="container-fluid feature-bg3 my-5">
                    <div className="card mb-3 feature-box container">
                        <div className="row g-5">
                            ...
                            <div className="col-md-5">
                                <div className="card-body">
                                    <h3 className="card-title text-white feature-title mb-5">Keep Track <span className="feature-title-color">Your Expenditure</span></h3>
