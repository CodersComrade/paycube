                ...
                <div className="container">
                    <div className="row g-3">
                        <div className="col-md-6">
                            <h2 className="rl-title text-white mt-5 mb-5">Log In <span className="rl-title-color">Your Account</span></h2>
                            <form className="row g-3">
                                ...
                                <div className="col-md-3">
                                    <input type="submit" className="btn btn-bg fw-bold mt-3 mb-5 rounded-pill" value="Sign In" />
                                </div>
